...
const translations = {
  pt: {
    ...
    contactEmailLabel: 'Email ou WhatsApp',
    contactEmailPlaceholder: 'email@exemplo.com ou +55 11 98765-4321',
    contactMessagePlaceholder: 'Como podemos ajudar você?',
    contactWhatsAppTitle: 'WhatsApp',
    contactWhatsAppDesc: 'Entre em contato direto pelo WhatsApp para respostas rápidas.',
    contactWhatsAppButton: 'Enviar mensagem',
    contactEmailTitle: 'Email',
    contactEmailDesc: 'Envie suas dúvidas por email e responderemos em breve.',
    contactScheduleTitle: 'Horário de Atendimento',
    contactScheduleWeekdays: 'Segunda a Sexta: 9h - 18h',
    contactScheduleSaturday: 'Sábado: 9h - 13h',
    
    // Modal de Perfil
    profileTitle: 'Perfil',
    profileViewProfile: 'Ver perfil',
    profileName: 'Nome',
    ...
    profileClickToChange: 'Clique no ícone da câmera para alterar',
    profileSaveButton: 'Salvar Alterações',
    profileLogoutButton: 'Sair da Conta',
    profileNamePlaceholder: 'Seu nome completo',
    profileEmailPlaceholder: 'seu@email.com',
    profilePhonePlaceholder: '+55 (11) 99999-9999',
    
    // Modal de Confirmação de Logout
    logoutConfirmTitle: 'Confirmação',
    logoutConfirmMessage: 'Deseja realmente sair?',
  ...
  en: {
    ...
    contactEmailLabel: 'Email or WhatsApp',
    contactEmailPlaceholder: 'email@example.com or +55 11 98765-4321',
    contactMessagePlaceholder: 'How can we help you?',
    contactWhatsAppTitle: 'WhatsApp',
    contactWhatsAppDesc: 'Contact us directly via WhatsApp for quick responses.',
    contactWhatsAppButton: 'Send message',
    contactEmailTitle: 'Email',
    contactEmailDesc: 'Send your questions by email and we will respond shortly.',
    contactScheduleTitle: 'Business Hours',
    contactScheduleWeekdays: 'Monday to Friday: 9am - 6pm',
    contactScheduleSaturday: 'Saturday: 9am - 1pm',
    ...
    profileClickToChange: 'Click the camera icon to change',
    ...
    logoutConfirmMessage: 'Do you really want to logout?',
  ...
  es: {
    ...
    contactEmailLabel: 'Correo o WhatsApp',
    contactEmailPlaceholder: 'correo@ejemplo.com o +55 11 98765-4321',
    contactMessagePlaceholder: '¿Cómo podemos ayudarte?',
    contactWhatsAppTitle: 'WhatsApp',
    contactWhatsAppDesc: 'Contáctanos directamente por WhatsApp para respuestas rápidas.',
    contactWhatsAppButton: 'Enviar mensaje',
    contactEmailTitle: 'Correo',
    contactEmailDesc: 'Envía tus preguntas por correo y responderemos pronto.',
    contactScheduleTitle: 'Horario de Atención',
    contactScheduleWeekdays: 'Lunes a Viernes: 9h - 18h',
    contactScheduleSaturday: 'Sábado: 9h - 13h',
    ...
    profileClickToChange: 'Haz clic en el ícono de la cámara para cambiar',
    profileSaveButton: 'Guardar Cambios',
